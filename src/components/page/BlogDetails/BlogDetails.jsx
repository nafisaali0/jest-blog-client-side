...
const BlogDetails = () => {
    ...
    return (
        <>
            <div className="bg-transparent p-5 text-start">
                <div className="space-y-6">
                    <div className="text-5xl font-bold text-black">
                        <h1>{title}</h1>
                    </div>
                    <div className="flex flex-row gap-5 items-center my-5 pb-5 border-b-2 border-borderColour drop-shadow-sm">
                        ...
                        <span className="cursor-pointer !rounded">
                            <FollowFunctionality email={owner_Email}></FollowFunctionality></span>
