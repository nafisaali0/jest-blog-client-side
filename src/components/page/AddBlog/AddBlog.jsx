...
const AddBlog = () => {
    ...
    const handleCreateBlog = e => {
        ...
        const details_image = e.target.filename.value;
        ...
        <div className="max-w-5xl mx-auto overflow-hidden my-20 p-5">
            <form onSubmit={handleCreateBlog}>
                <div className="flex justify-between items-center">
                    <div>
                        <button className='px-3 py-2 bg-[#5b608b] text-lg text-white font-semibold rounded-xl'><input type="file" id="myFile" name="filename" /></button>
                    </div>
                    <div>
                        <button className='px-3 py-2 bg-[#5b608b] text-lg text-white font-semibold rounded-xl'>Publish</button>
                    </div>
                </div>
                <div className="mt-10">
                ...
                <div className="my-3">
                    <label htmlFor="Title" className="text-2xl font-bold">Blog Category</label>
                    <input type="category" name="category" placeholder="Category" className="bg-transparent my-5 py-5 w-full text-lg border-gray-300 border-b-2 outline-none placeholder:text-4xl" />
                </div>
                <div className="my-3">
