...
const test = () => {
    return (
        <>
            <section className="w-full overflow-hidden dark:bg-mainTheme">
                <div className="w-full mx-auto">
                    ...
                    <div
                        ...
                        <p className="w-full text-gray-700 dark:text-gray-400 text-md text-pretty sm:text-center text-justify">Lorem, ipsum dolor sit amet
                        ...
                        <div className="w-full flex gap-4 justify-center items-center mt-10">
                            ...
                            <div
                                className="xl:w-1/4 xl:h-32 lg:w-1/5 lg:h-32 md:w-1/5 md:h-28 sm:w-1/3 sm:h-[5rem] w-1/3 h-[4rem] flex justify-center items-center rounded-sm text-center text-lg px-6 py-4 border-2 border-dashed border-gray-300 dark:text-white dark:border-2 dark:border-dashed dark:border-gray-700">
                                27
                            </div>
