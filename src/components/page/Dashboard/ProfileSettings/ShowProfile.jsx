                    ...
                    isfollowers?.length === 0 ?
                        <>
                            <div className="my-20 flex flex-col justify-center items-center">
                                <div>
                                    <h1 className="text-xl text-center font-bold text-textSmallGray">No Followes</h1>
                                </div>
                            </div>
                                        ...
                                        <>
                                            <div className="bg-white rounded-xl shadow-xl p-8 lg:max-w-lg w-full  hover:shadow-bodyColor border border-borderColour">
                                                <div className="flex items-center space-x-4">
                                                    <div className="avatar">
                                                        <div className="w-16 rounded-xl">
                                                            <img src={follower.followersImage} />
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <h2 className="text-xl font-semibold text-black">{follower.followersName}</h2>
                                                        <p className="text-[12px] font-normal text-textSmallGray truncate whitespace-nowrap overflow-hidden">{follower.followersEmail}</p>
                                                    </div>
                                                </div>
                                                <div className="mt-4 flex justify-between items-center">
                                                    ...
                                                    {/* /blogs/bloggeremail/${follower.followersEmail} */}
                                                    {/* {`/blogdetails/${_id}`} */}
                                                    {/* /bloggeremail/:email */}
                                                    <div className="text-textSmallGray text-sm">
                                                        <a href={`/blogs/bloggeremail/${follower?.followersEmail}`}>
