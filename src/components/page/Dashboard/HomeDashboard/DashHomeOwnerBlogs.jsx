...
const DashHomeOwnerBlogs = () => {
    ...
    return (
        <>
            ...
            <div className="flex items-start justify-start flex-col-reverse lg:flex-row gap-7 my-10">
                <div className="w-full lg:w-2/4 pr-5">
                    <h1 className="w-fit text-start text-sm font-bold px-6 py-2 bg-purple border-purple rounded-full border-2">All Blogs</h1>
                </div>
                <div className="w-full lg:w-2/4 pr-5">
                    <h1 className="w-fit text-start text-sm font-bold px-6 py-2 bg-purple border-purple rounded-full border-2">Subscriptions Blogs</h1>
                </div>
            </div>
            <div className="flex items-start justify-start flex-col-reverse lg:flex-row gap-7">
                ...
                <div className="w-full lg:w-2/4 h-96 overflow-y-scroll pr-4">
                    <div className="flex flex-col gap-5">
                        {
                            userBlogs.map((ownerBlogs, index) => (
                                <div key={index} className="bg-card_white p-5 rounded-xl drop-shadow-md">
