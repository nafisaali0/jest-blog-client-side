    ...
    return (
        <>
            ...
            <div className="flex items-start justify-start flex-col-reverse lg:flex-row gap-7">
                <div className="w-full lg:w-2/4 h-96 pr-5 overflow-y-scroll">
                    <div>
                        {
                            userBlogs.map(ownerBlogs =>
                                <>
                                    <div className="bg-card_white my-5 p-5 rounded-xl drop-shadow-md">
                                        <div className="flex items-center gap-5 py-2">
                                            ...
                                            <div className="flex-1">
                                                <span className='px-5 py-2 bg-light_gray text-xs text-black border-1 border-light_gray font-semibold rounded-full'>{ownerBlogs.category}</span>
                                                <Link to={`/blogdetails/${ownerBlogs._id}`} target="_blank">
                                                ...
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <div>
                                                        <Link to={`/update/${ownerBlogs._id}`}><img title="Update" className="w-9 cursor-pointer" src={icon2} alt="" /></Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="w-full lg:w-2/4 h-96 overflow-y-scroll pr-4 relative">
                    <div className="sticky top-0 z-10 text-sm font-bold px-6 py-2 bg-purple border-purple rounded-full border-2">
                        <h1>Your Subscription Blogs</h1>
                    </div>
