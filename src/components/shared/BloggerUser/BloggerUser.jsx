                            ...
                            <>
                                <div
                                    ...
                                    <div className="flex items-center gap-4">
                                        <img src={blog?.owner_image} className="w-24 group-hover:w-28 group-hover:h-28 h-24 object-center object-cover rounded-full transition-all duration-500 delay-500 transform"
                                        />
                                        <div className="w-fit transition-all transform duration-500 space-y-2">

                                            {
                                                currentUser?.email !== blog?.owner_Email ?
                                                    <Link className='text-xm font-bold' to={`/profile-blogger/${encodeURIComponent(blog.owner_Email)}`}>
                                    ...
                                    <div className="absolute group-hover:bottom-1 delay-300 -bottom-16 transition-all duration-500 right-1 rounded-lg">
                                        <FollowFunctionality email={blog?.owner_Email} />
                                    </div>
                                </div>
                            </>
                        )
